                ...
                <Row>
                    <div>
                        <Col className='' offset={2} span={20}>
                            ...
                            <div style={{marginTop: 40, color: 'red', fontStyle: 'italic', fontSize: 18}}>Why is it
                                called
                                Chatq?
                            </div>
                            ...
                            <div style={{marginTop: 10, fontSize: 16}}>Nowadays, in the technology era, internet
                                literally
                                floods us with information about everything,
                                but not always with one that brings us satisfaction makes us more knowledgeable, aware
                                or
                            ...
                            <div style={{marginTop: 10, fontSize: 16}}>Chatq is a place for pictures and stories, or
                                more
                                accurate stories with pictures.
                                To create your story you should have a storyline consisting of 4 photos which are
                                directly
                            ...
                            <div style={{marginTop: 5, fontSize: 16, fontStyle: 'italic'}}>Four is a magical number
                            </div>
                            <div style={{marginTop: 10, fontSize: 16}}>Because we understand the world better because of
                                its
                                four directions,
                                ...
                                And last but not least, 4 are the elements of each story - introduction, thesis,
                                statement
                                and conclusion.
                            </div>
                            <div style={{marginTop: 20, color: 'red', fontStyle: 'italic', fontSize: 18}}>Is there
                                something
                                more?
                            </div>
                            <div style={{marginTop: 10, marginBottom: 50, fontSize: 16}}>Oh, yes :).One more thing.
                                There
